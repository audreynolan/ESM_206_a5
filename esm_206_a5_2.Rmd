...
ggplot(data = weight_channel, aes(x = unittype, 
  ...
  labs(title = "Figure 2: Distribution of Pacific Giant Salamander weights across each location-classification", 
       caption = "Figure 2 illustrates the distribution of Salamander weights across each location-classifications, regardless of clear cut or old-growth forest.", 
